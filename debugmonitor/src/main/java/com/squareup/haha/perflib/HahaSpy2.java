...
/**
 * Program type already present: haha.perflib.HahaSpy
 * 因为 leakcanary-analyzer:1.6.3 里面也有 HahaSpy！！
 */
public final class HahaSpy2 {
    ...
    public static Set<RootObj> allGcRootSjh(Snapshot snapshot) {
        Set<RootObj> allRoots = new HashSet();
        Iterator var2 = snapshot.getHeaps().iterator();
