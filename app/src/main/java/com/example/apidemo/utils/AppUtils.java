...
public final class AppUtils {
    ...
    /**
     * 得到CPU核心数
     * ps：nexeus对应目录内含有cpu0 ~ cpu5 的文件夹，即6核
     *
     * @return CPU核心数
     */
            ...
            for (RunningAppProcessInfo process : processList) {
                ...
                if (process.importance > RunningAppProcessInfo.IMPORTANCE_VISIBLE) {
                    ...
                    for (String pkgName : pkgList) {
                        try {
                            am.killBackgroundProcesses(pkgName);    // todo 需要加权限
                            count++;
    ...
    public static String getCurrentRuntimeValue() {
        try {
            ...
            try {
                ...
                try {
                    final String value = (String) method.invoke(systemProperties, "persist.sys.dalvik.vm.lib",
                ...
                e.printStackTrace();
                Log.e(TAG, "SystemProperties.get(String key, String def) method is not found");
                return null;
            }
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
            Log.e(TAG, "SystemProperties class is not found");
            return null;
        }
    }
