...
package com.example.apidemo.utils.string;
...
public class HanziToPinyin {
     ...
     * for all ~20k unihans.
     *
     * [呵, 哎, 安, 肮, 凹, 八, 挀, 扳, 邦, 包, 卑, 奔, 伻, 屄, 边, 标, 憋, 邠, 槟, 癶, 峬, 嚓, 婇, 飡, 仓, 操, 冊, 嵾, 噌, 叉, 钗, 辿, 伥,
     * 抄, 车, 抻, 柽, 吃, 充, 抽, 出, 欻, 揣, 川, 疮, 吹, 杶, 逴, 疵, 匆, 凑, 粗, 汆, 崔, 邨, 搓, 咑, 大, 疸, 当, 刀, 淂, 得, 扥, 灯, 氐,
     * 嗲, 甸, 刁, 爹, 仃, 丟, 东, 唗, 嘟, 偳, 堆, 鐓, 多, 婀, 诶, 奀, 鞥, 而, 发, 帆, 方, 飞, 分, 丰, 覅, 仏, 紑, 伕, 旮, 该, 甘, 冈, 皋,
     * 戈, 給, 根, 庚, 工, 勾, 估, 瓜, 罫, 关, 光, 归, 衮, 呙, 哈, 咳, 顸, 苀, 蒿, 诃, 黒, 拫, 亨, 噷, 吽, 齁, 匢, 花, 怀, 犿, 巟, 灰, 昏,
     * 吙, 丌, 加, 戋, 江, 艽, 阶, 巾, 劤, 冂, 勼, 匊, 娟, 噘, 军, 咔, 开, 刊, 闶, 尻, 匼, 剋, 肯, 阬, 空, 抠, 刳, 夸, 蒯, 宽, 匡, 亏, 坤,
     * 扩, 垃, 来, 兰, 啷, 捞, 仂, 勒, 塄, 刕, 倆, 奁, 良, 撩, 列, 拎, 〇, 溜, 龙, 瞜, 噜, 娈, 畧, 抡, 罗, 呣, 妈, 霾, 嫚, 邙, 猫, 麼, 沒,
     * 门, 甿, 咪, 眠, 喵, 咩, 民, 名, 谬, 摸, 哞, 毪, 拏, 孻, 囡, 囊, 孬, 讷, 馁, 恁, 能, 妮, 拈, 嬢, 鸟, 捏, 您, 宁, 妞, 农, 羺, 奴, 奻,
     * 虐, 挪, 喔, 讴, 趴, 拍, 眅, 乓, 抛, 呸, 喷, 匉, 丕, 偏, 剽, 氕, 姘, 乒, 钋, 剖, 仆, 七, 掐, 千, 呛, 悄, 癿, 侵, 靑, 邛, 丘, 曲, 弮,
     * 缺, 夋, 呥, 穣, 娆, 惹, 人, 扔, 日, 茸, 厹, 如, 堧, 桵, 闰, 若, 仨, 毢, 三, 桒, 掻, 色, 森, 僧, 杀, 筛, 山, 伤, 弰, 奢, 申, 升, 尸,
     * 収, 书, 刷, 摔, 闩, 双, 谁, 吮, 妁, 厶, 忪, 捜, 苏, 狻, 夊, 孙, 唆, 他, 苔, 坍, 铴, 夲, 忑, 熥, 剔, 天, 佻, 帖, 厅, 囲, 偷, 鋀, 湍,
     * 推, 吞, 托, 挖, 歪, 弯, 尪, 危, 塭, 翁, 挝, 兀, 夕, 虾, 仚, 乡, 灱, 些, 心, 星, 凶, 休, 旴, 轩, 疶, 勋, 丫, 恹, 央, 幺, 耶, 一, 欭,
     * 应, 哟, 佣, 优, 扜, 鸢, 曰, 晕, 匝, 災, 糌, 牂, 傮, 则, 贼, 怎, 増, 吒, 捚, 沾, 张, 钊, 蜇, 贞, 争, 之, 中, 州, 朱, 抓, 跩, 专, 妆,
     * 隹, 宒, 卓, 孜, 宗, 邹, 租, 钻, 厜, 尊, 昨]
     */
    ...
    public static HanziToPinyin getInstance() {
        synchronized (HanziToPinyin.class) {
            ...
            for (int i = 0; i < locale.length; i++) {
                if (locale[i].equals(Locale.CHINA) || locale[i].equals(Locale.CHINESE)) {   // nexeus内竟然没有 zh_CN
            ...
            Log.e(TAG, "There is no Chinese collator, HanziToPinyin is disabled");
