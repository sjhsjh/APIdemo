...
class GlobalScreenshot {
     ...
     */
    void takeScreenshot(Bitmap bitmap, onScreenShotListener onScreenShotListener, boolean statusBarVisible,
...
//        mScreenshotView.setScaleY(SCREENSHOT_SCALE);
        ...
        anim.addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                mScreenshotFlash.setAlpha(flashAlphaInterpolator.getInterpolation(t));  // 闪白屏模拟拍照
            }
        });
        return anim;
    }
    ...
    private void showShotPreview() {
        ...
        imageView.setImageBitmap(mScreenBitmap);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(imagePath)) {
                    BitmapUtils.openImage(mContext, imagePath);
                }
            }
        });
